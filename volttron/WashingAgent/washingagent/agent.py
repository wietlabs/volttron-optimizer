...
def washingagent(config_path, **kwargs):
    ...
    return Washingagent(setting1,
                          setting2,
                          **kwargs)


class Washingagent(Agent):
    """
    ...
    def __init__(self, setting1=1, setting2="some/random/topic",
                 **kwargs):
        super(Washingagent, self).__init__(**kwargs)
